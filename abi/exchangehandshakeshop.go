...
// InitByCustomer is a paid mutator transaction binding the contract method 0x1746049d.
//
// Solidity: function initByCustomer(shopOwner address, value uint256, offchain bytes32) returns()
func (_ExchangeHandshakeShop *ExchangeHandshakeShopTransactor) InitByCustomer(opts *bind.TransactOpts, shopOwner common.Address, value *big.Int, offchain [32]byte) (*types.Transaction, error) {
	return _ExchangeHandshakeShop.contract.Transact(opts, "initByCustomer", shopOwner, value, offchain)
}

// InitByCustomer is a paid mutator transaction binding the contract method 0x1746049d.
//
// Solidity: function initByCustomer(shopOwner address, value uint256, offchain bytes32) returns()
func (_ExchangeHandshakeShop *ExchangeHandshakeShopSession) InitByCustomer(shopOwner common.Address, value *big.Int, offchain [32]byte) (*types.Transaction, error) {
	return _ExchangeHandshakeShop.Contract.InitByCustomer(&_ExchangeHandshakeShop.TransactOpts, shopOwner, value, offchain)
}

// InitByCustomer is a paid mutator transaction binding the contract method 0x1746049d.
//
// Solidity: function initByCustomer(shopOwner address, value uint256, offchain bytes32) returns()
func (_ExchangeHandshakeShop *ExchangeHandshakeShopTransactorSession) InitByCustomer(shopOwner common.Address, value *big.Int, offchain [32]byte) (*types.Transaction, error) {
	return _ExchangeHandshakeShop.Contract.InitByCustomer(&_ExchangeHandshakeShop.TransactOpts, shopOwner, value, offchain)
}

// InitByShopOwner is a paid mutator transaction binding the contract method 0xd1d72e38.
//
// Solidity: function initByShopOwner(value uint256, offchain bytes32) returns()
func (_ExchangeHandshakeShop *ExchangeHandshakeShopTransactor) InitByShopOwner(opts *bind.TransactOpts, value *big.Int, offchain [32]byte) (*types.Transaction, error) {
	return _ExchangeHandshakeShop.contract.Transact(opts, "initByShopOwner", value, offchain)
}

// InitByShopOwner is a paid mutator transaction binding the contract method 0xd1d72e38.
//
// Solidity: function initByShopOwner(value uint256, offchain bytes32) returns()
func (_ExchangeHandshakeShop *ExchangeHandshakeShopSession) InitByShopOwner(value *big.Int, offchain [32]byte) (*types.Transaction, error) {
	return _ExchangeHandshakeShop.Contract.InitByShopOwner(&_ExchangeHandshakeShop.TransactOpts, value, offchain)
}

// InitByShopOwner is a paid mutator transaction binding the contract method 0xd1d72e38.
//
// Solidity: function initByShopOwner(value uint256, offchain bytes32) returns()
func (_ExchangeHandshakeShop *ExchangeHandshakeShopTransactorSession) InitByShopOwner(value *big.Int, offchain [32]byte) (*types.Transaction, error) {
	return _ExchangeHandshakeShop.Contract.InitByShopOwner(&_ExchangeHandshakeShop.TransactOpts, value, offchain)
}
